var gAjax=function(a,b){this.name="G-Ajax";this.version="1.0.2";this.baseURL=a.replace(/\/{1,}$/,"");this.tokenName=b.tokenName;this.accessToken=b.accessToken};gAjax.prototype.gajaxVersion=function(){return JSON.stringify({name:this.name,version:this.version})};gAjax.prototype.prepareRequest=function(a){a=void 0===a?null:a;var b=this.baseURL;null!==a&&(/^\/{1,}/.test(a)&&(a=a.replace(/^\/{1,}/,"")),b+="/"+a);return b.replace(/\/{1,}$/,"")};
gAjax.prototype.encodeParams=function(a){var b=[],c;for(c in a){var d=a[c];d=encodeURIComponent(c)+"="+encodeURIComponent(d);b.push(d)}return b.join("&").replace(/%20/g,"+")};
